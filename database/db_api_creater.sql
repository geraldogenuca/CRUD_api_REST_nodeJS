...
CREATE SCHEMA IF NOT EXISTS `db_crud_api` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;

CREATE TABLE IF NOT EXISTS `db_crud_api`.`Categories` (
...
CREATE TABLE IF NOT EXISTS `db_crud_api`.`Products` (
  ...
  CONSTRAINT `fk_Products_Categories`
    ...
    REFERENCES `db_crud_api`.`Categories` (`id_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `db_crud_api`.`Images` (
  ...
  CONSTRAINT `fk_Images_Products1`
    ...
    REFERENCES `db_crud_api`.`Products` (`id_product`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `db_crud_api`.`Costumers` (
...
CREATE TABLE IF NOT EXISTS `db_crud_api`.`Orders` (
  ...
  CONSTRAINT `fk_Orders_Costumers1`
    ...
    REFERENCES `db_crud_api`.`Costumers` (`id_costumer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
