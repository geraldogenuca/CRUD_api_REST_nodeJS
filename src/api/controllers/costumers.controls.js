...
class CostumersControllers {
    ...
    async create(req, res) {
        try {
            ...
            `
            const result_check = await client.execute(query_check, [req.body.email_costumer])
        ...
        try {
            const query_check = `
                SELECT      id_costumer
                    ...
                    WHERE   id_costumer = ?;
            `
            const result_check = await client.execute(query_check, [req.params.id_costumer])
    ...
    async update(req, res) {
        try {
            ...
            await client.execute(query, [
                req.body.name_costumer, req.body.email_costumer, 
                req.body.password_costumer, req.params.id_costumer
            ])
